...
class Observation ():
    ...
    def print(self):
        print ('satellite : ',self.satellite, 'fenêtre visible : ', self.visibility_window)
...
class VisibilyWindowComputer ():
    ...
    def computeVisibilityWindow(self, satellite):
        if satellite.tle :
            ...
            t, events = satellite.tle[0].find_events(bluffton, t0, t1, altitude_degrees = satellite.min_elevation)
            ...
            for ti, event in zip(t, events):
                ...
                if name == 'rise':
                    ...
                    visibility_window_open = True
                        ...
                        t_culminate = ti
                        topocentric_position = (satellite.tle[0] - bluffton).at(t_culminate)
                    ...
                    if visibility_window_open :
                        ...
                        if alt.degrees > satellite.min_culmination : 
                            satellite.add_visibility_window(t_rise, t_set, t_culminate)
